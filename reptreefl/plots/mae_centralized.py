...
methods = ['RepFL', 'ReplicaFL', 'Centralized']
...
plot_colours = ['deepskyblue', 'cornflowerblue', 'lightcoral']
...
plt.savefig(f'{SAVING_FOLDER_PATH}/{GLOBAL_RUN_NAME}/average_runs_{160}_mae_centralized.png')
...
plt.savefig(f'{SAVING_FOLDER_PATH}/{GLOBAL_RUN_NAME}/average_runs_{268}_mae_centralized.png')
