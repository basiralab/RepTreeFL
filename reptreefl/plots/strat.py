...
methods = ['RepFL', 'ReplicaFL', 'RepFL strat', 'ReplicaFL strat']
...
plot_colours = ['deepskyblue', 'cornflowerblue', 'lightskyblue', 'darkcyan']
...
plt.savefig(f'{SAVING_FOLDER_PATH}/{GLOBAL_RUN_NAME}/strat_analysis.png')
